...
export default {
  ...
  methods: {
    ...
    async enviarDados() {
      ...
      const apiUrlEvent = `https://9da1-2804-47e4-8842-8300-7c25-dfaf-9335-e51c.ngrok-free.app/events/${this.eventDetails.id}`;
      const apiUrlGuest = "https://9da1-2804-47e4-8842-8300-7c25-dfaf-9335-e51c.ngrok-free.app/guest";
      const apiUrlCompanion = "https://9da1-2804-47e4-8842-8300-7c25-dfaf-9335-e51c.ngrok-free.app/companion";
      const apiUrlGuestAndEvent = "https://9da1-2804-47e4-8842-8300-7c25-dfaf-9335-e51c.ngrok-free.app/eventAndGuests";
